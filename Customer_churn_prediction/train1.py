...
os.makedirs(os.path.dirname("C:\Users\JMRH\Desktop\data\processed\churn_processed.csv"), exist_ok=True)
...
def main():
    print("Loading raw data:", "C:\Users\JMRH\Downloads\WA_Fn-UseC_-Telco-Customer-Churn.csv")
    df = pd.read_csv("C:\Users\JMRH\Downloads\WA_Fn-UseC_-Telco-Customer-Churn.csv")
    print("Raw shape:", df.shape)

    print("Preprocessing...")
    df_proc = preprocess(df)
    df_proc.to_csv("C:\Users\JMRH\Desktop\data\processed\churn_processed.csv" index=False)
    print("Saved processed CSV to:", "C:\Users\JMRH\Desktop\data\processed\churn_processed.csv")
